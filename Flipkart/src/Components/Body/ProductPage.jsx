...
const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    if (filters.Brand?.length > 0) {
      sorted = sorted.filter((x) => filters.Brand.includes(x.Brand || x.name));
    }
      ...
      <div className="watch-mobile">
        ...
        <div className="watch-product">
          {result.map((x, index) => (
            <div
              key={index}
              className="watch-flex"
              onClick={() => navigate(`/productPage/productdetails/${index}`)}
            >
                    ...
                    <div className="watch-items">
                      <div className="watch-item-box">
                        ...
                        <div className="watch-rating-box">
                          <div className="watch-rating-box-container">
                            ...
                            <div className="watch-rating-users">
                              | {x.users}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="watch-item-text">
                        ...
                        <div className="watch-item-text-price">
                          ...
                          <div className="watch-item-priceog">
                            ₹{x.discount}
                          </div>
                        ...
                        <div className="watch-item-text-offer">
                          ...
                          <div className="watch-textoffer-price">
                            {" "}
                            ₹{x.bank}{" "}
                          </div>
