        ...
        <div className="tab-header-items">
          ...
          <div className="tab-header-item">
            <div className="tab-logo">
              <div className="tab-logo-box">
                ...
                <a href="" className="tab-logo-box-text">
                  Explore <span className="tab-logo-box-text-span">Plus</span>
                  <img
                    width="10"
            ...
            <div className="tab-header-box">
              <a href="" className="tab-header-box-text">
      ...
      <div className="tab-main">
        <div className="tab-main-shape">
            ...
            <div className="tab-filter-main">
                ...
                <div className="tab-categories">
                  <div className="tab-filter-box">
                    ...
                    <div className="tab-categories-text">
                      ...
                      <a href="" className="tab-categories-text-text">
                        Watches
                      </a>
                    </div>
                    <div className="tab-categories-text">
                      <a href="" className="tab-categories-text-a">
                        Wrist Watches
                      </a>
                    </div>
                  </div>
              ...
              <div className="tab-filter-section">
                <a className="tab-filter-pic">
                  ...
                  <div className="tab-filter-pic-heading">
          ...
          <div className="tab-product">
            <div className="tab-product-heading">
              <div className="tab-product-heading-box">
                <div>
                ...
                <div className="tab-product-heading-total">
                    ...
                    <div className="tab-product-box-main">
                      <a href="" className="tab-product-box-main-a">
                        <div className="tab-product-pic-box">
                          <div className="tab-product-box-pic">
                            <img alt="" src={x.image} />
                          </div>
                        </div>
                      ...
                      <div className="tab-product-box-text">
                        <div className="tab-product-sponsored">
                          <svg
                            width="62"
                            height="18"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a className="tab-product-price-box">
                          ...
                          <div className="tab-product-off">{x.off} % off</div>
                        </a>
                      </div>
                    </div>
                  </div>
